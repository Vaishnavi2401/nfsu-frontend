        ...
        if (a === 'resourcePath') {
            ...
            return <span>
                {visibility == true ?
                    ...
                    :
                    <button type="primary" className="btn btn-default" onClick={() => [openModal1(path, id)]}>{title}</button>
                }
                ...
                <Modal1 isOpen={getModalState2.show} style={customStyles1}>
                    <Container style={{ maxWidth: '100%' }}>
                        ...
                        <Row>
                            <Col sm={5}></Col>
                            <Col sm={2} style={{ textAlign: 'center' }}><a href="#"><i className="las la-window-close" onClick={() => [closeModal1()]} style={{ fontSize: "35px", color: "green" }}></i></a></Col>
                            <Col sm={5}></Col>
                        </Row>
                    </Container>
                </Modal1>
