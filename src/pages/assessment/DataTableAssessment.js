...
import { GlobalContext } from '../courses/contentdelivery/contexts/GlobalContext';
import {Communication, USER_API, Assessment_Delivery} from '../../services/service';
                    ...
                    .then(async res1 => {
                        ...
                        if (parseInt(res1.data.score) >= parseInt(res1.data.passmarks)) {
                            ...
                            axios({
                                method: 'post',
                                data: params,
                                url: `${Communication}/Assessment/quiz/updateAssignMasterResultDelcare?tenant_id=${tenantId}`,
                            })
                                .then((response) => {
