...
import {DMS, DMS_URL, Frontend_UI} from "./../../../services/service";
          ...
          <div>
            ...
            getContentType === "jpeg" ? (
              <img
                ...
                height="100%"
              ></img>
            ) : // : getContentType === "pdf" ? <iframe width="100%" height="800" src={DMS_URL + `/${getUrl}`+ "#toolbar=0"} type="application/pdf" embedded="true" onContextMenu={handleContextMenu}></iframe>
            getContentType === "pdf" ? (
              <div>
                {" "}
                <ViewPdf
