                                    ...
                                    <div class="form-card">
                                        ...
                                        <p className="form-control">
                                            ...
                                            <img src={getIconImg.imagePreviewUrl == null ?
                                                `${COURSE_URL}/${getCourseDetails.imageUrl}` : getIconImg.imagePreviewUrl}
                                        ...
                                        <p className="form-control">
                                            ...
                                            <img src={getBannerImg.imagePreviewUrl == null ?
                                                `${COURSE_URL}/${getCourseDetails.banner}` : getBannerImg.imagePreviewUrl}
                                        ...
                                        <p className="form-control">
                                            ...
                                            <br></br>
                                            {/* <video src={`${COURSE_URL}/${getCourseDetails.video}`}  width="400" controls>
                                            </video> */}
                                            {getVideoState ? <video src={`${COURSE_URL}/${getCourseDetails.video}`} id="video" width="400" controls>
