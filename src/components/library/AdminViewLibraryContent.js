...
function AdminViewLibraryContent(props) {
    ...
    const imageUrls = (url) => {
        if (url == null) {
            ...
            let imageurl = `http://gfsu3.hyderabad.cdac.in:8082/${imagepath}`;
            return imageurl;
        }
                                ...
                                <Container style={{ "maxWidth": "100%" }}>
                                    <Row>
                                        ...
                                        {/* <div className="course-details-banner">
                                                <img src={process.env.PUBLIC_URL + `http://gfsu3.hyderabad.cdac.in:8082/${courseDetails.imageUrl}`} style={{ borderRadius: '5px', width: "400px" }} alt="Course Image" className="img-fluid" />
                                                                                                                ...
                                                                                                                <div className='card text-center shadow'>
                                                                                                                    ...
                                                                                                                    <div className='card-body text-dark'>
                                                                                                                        ...
                                                                                                                        <p className='card-text text-secondary'>
                                                                                                                            ...
                                                                                                                            <Button variant="success" style={{ marginRight: "10px" }} onClick={() => { onClickViewContent(content.filePath, content.nodetype,content.label) }} >{t('view')}</Button>
                                                                                                                            {
                                                                                                                                content.status === "C"
                                                                                                                                    ?
                                                                                                                                    <>
                                                                                                                                        <Button style={{ marginRight: "10px" }} onClick={() => { onClickApproveButton(content.id) }}>{t('approve')}</Button>
