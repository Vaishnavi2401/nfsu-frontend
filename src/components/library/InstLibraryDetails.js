...
function InstLibraryDetails(props) {
    ...
    const ShareUrl = (url) => {
        instructorService.contentAccess(url).then((res) => {
            ...
            setShareUrlData("http://gfsu3.hyderabad.cdac.in:8080/" + res.data);
    ...
    const courseStructurContentView = (contentType, fileUrl) => {
        if (contentType == "youtube") {
            ...
            instructorService
                .contentAccess("http://gfsu3.hyderabad.cdac.in:8080/" + fileUrl)
                .then((res) => {
                    if (contentType === "pdf") {
                        // This encodes the Actual URL
                        const encrypted = CryptoJS.AES.encrypt(
    ...
    const newArr = selectedRows.map(
        ({
            ...
            let newPath = originalUrl.replace("http://gfsu3.hyderabad.cdac.in:8080/", "");
    ...
    return (
        ...
        >
            ...
            <BreadcrumbBox
                ...
                bannerUrl={`http://gfsu3.hyderabad.cdac.in:8082/${getCourseDetails.banner}`}
            />
                                                ...
                                                <div className="course-details-banner">
                                                    <img
                                                        src={
                                                            ...
                                                            `http://gfsu3.hyderabad.cdac.in:8082/${getCourseDetails.imageUrl}`
                                                        }
                                                        alt="Course Image"
                ...
                <Modal.Body>
                    {getContentType === "jpg" ||
                        ...
                        <div>
                            {" "}
                            <ViewPdf
                                pdfUrl={`http://gfsu.hyderabad.cdac.in/pdfViewer/${getUrl}`}
                            />
                        </div>
                    ) : getContentType === "mp4" ? (
                        <div>
