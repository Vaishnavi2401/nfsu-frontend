        ...
        <fieldset>
            <div class="form-card">
                ...
                <p className="form-control">
                    ...
                    <br></br>
                    <img src={props.courseIconUrl == '' ? "http://gfsu3.hyderabad.cdac.in:8080/uploads/DefaultImage/default.jpg" : props.courseIconUrl}
                        style={{ height: '150px', width: '200px' }} />
                    {/* "http://gfsu3.hyderabad.cdac.in:8080/uploads/DefaultImage/default.jpg" */}
                </p>
