                                    ...
                                    <Row>
                                        <Col lg="3" md="5" sm="12">
                                            <div className="course-details-banner">
                                                ...
                                                <img src={process.env.PUBLIC_URL + `${COURSE_URL}/${courseDetails.imageUrl}`} style={{ borderRadius: '5px', width: "400px" }} alt="Course Image" className="img-fluid" />

                                                {/* <img src={process.env.PUBLIC_URL + `${COURSE_URL}/${courseDetails.imageUrl}`} style={{ height: 300, width: 825 }} alt="Course Image" className="img-fluid" /> */}
