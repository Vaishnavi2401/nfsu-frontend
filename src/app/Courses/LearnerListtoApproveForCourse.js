...
import {USER_API} from '../../services/service.js';
...
function LearnerListtoApproveForCourse() {
    ...
    const [getCourseType, setCourseType] = useState("free");
        ...
        // },
        {
            ...
            cell: (row) => <div>
                <div className="d-inline-block">
                    <button onClick={() => shareUrlModalShow(row.firstName, row.lastName, row.email, row.mobile, row.designation, row.eduQualification, row.dob,
                     row.address, row.idproofpicpath, row.profilepicpath, row.ddcertificate, row.middleName, row.idproofNumber, row.title, row.mobile1, row.instituteName)}
    ...
    const shareUrlModalShow = (firstName, lastName, email, mobile, designation, eduQualification, dob, address, idproofpicpath, profilepicpath, ddcertificate, middleName, idproofNumber, title, mobile1, instituteName) => {
                ...
                <Modal.Body>
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td>Name : </td>
                                <td>{ShareUrlModal.title} {ShareUrlModal.firstName} {ShareUrlModal.lastName}</td>
                            </tr>
                            <tr>
                                <td>Date Of Birth : </td>
                            ...
                            <tr>
                                <td>Mobile : </td>
                                <td>{ShareUrlModal.mobile}, {ShareUrlModal.mobile1}</td>
                            </tr>
                            <tr>
