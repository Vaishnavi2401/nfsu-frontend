...
export default function CourseWiseLearnerList() {
    ...
    const shareUrlModalShow = (firstName, lastName, designation, mobile, email, dob, eduQualification, enrolmentDate, courseName, catName, courseSDate, courseEDate, quizPassingStatus) => {
        ...
        },
        {
            ...
            cell: (row) => <div>
                <span className="d-inline-block">
                    <button
                        onClick={() => shareUrlModalShow(row.firstName, row.lastName, row.designation, row.mobile, row.email, row.dob, row.eduQualification, row.enrolmentDate, row.courseName, row.catName, row.courseSDate, row.courseEDate, row.quizPassingStatus)}
    ...
    const tableExportExcel = () => {
        ...
        if (getLearnerData !== undefined) {
            getLearnerData.map((data) => {
                ...
                const instData = [name, email, mobile, designation, , dobFormatted, eduQualification, enrolmentDateFormatted, courseName, catName, courseSDateFormatted, courseEDateFormatted, quizreport]
    ...
    const tableExportPDF = () => {
        ...
        const headers = [["Name", "E-mail", "Mobile No.", "Designation", "Date of Birth", "Qualification", "Enrollment Date", "Course Name", "Category Name", "Course Start Date", "Course End Date", "Quiz Report"]];
